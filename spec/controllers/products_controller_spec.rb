...
RSpec.describe ProductsController, type: :controller do
  let(:product_with_items) { create(:product, :with_line_item) }
  ...
  describe "DELETE #destroy" do
    ...
    it 'does not destroy if line_items exist for given product' do
      product_with_items
      expect {
        delete :destroy, params: {id: product_with_items.id}
